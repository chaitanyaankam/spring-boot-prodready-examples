...
insert into land (survey_no, area, unit, address_line1, land_mark, city, state, postal_zip_code, number_of_farms)
values('240/D/1', 1, 'acre', 'Raidurgam','near bio-diversity park', 'Hyderabad', 'Telangana', '500032', 5);
