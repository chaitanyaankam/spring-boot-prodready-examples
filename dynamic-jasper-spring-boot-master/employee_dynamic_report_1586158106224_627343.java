/*
 * Generated by JasperReports - 6/4/20 12:58 PM
 */
 ...
 *
 */
public class employee_dynamic_report_1586158106224_627343 extends JREvaluator
{
    ...
    private JRFillParameter parameter_page_title = null;
    ...
    private void initParams(Map pm)
    {
        ...
        parameter_page_title = (JRFillParameter)pm.get("page_title");
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.String)parameter_page_title.getValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.String)field_name.getValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.String)field_id.getValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = ((java.lang.String)field_designation.getValue()); //$JR_EXPR_ID=11$
                break;
            }
           default :
           {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 9 : 
            {
                value = ((java.lang.String)field_name.getOldValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.String)field_id.getOldValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = ((java.lang.String)field_designation.getOldValue()); //$JR_EXPR_ID=11$
                break;
            }
           default :
           {
